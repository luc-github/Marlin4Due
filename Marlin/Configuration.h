...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_DAVINCI
  #define MODEL 1 // 0 for old MB (JP4)- 1 for new MB (J37)
  #define DAVINCI 1 // difference between printer : 0 for for (BED 15*200-...) 1 for (BED 200*200-....)   
#endif
...
//    #define  DEFAULT_Kd 440
    ...
    #define  DEFAULT_Kp 93.01
    #define  DEFAULT_Ki 13.33
    #define  DEFAULT_Kd 162
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,2560,99}  // default steps per unit for Ultimaker
...
#define DAVINCI_PANEL		//DAVINCI LCD　16X4	
